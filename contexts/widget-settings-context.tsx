...
const WidgetSettingsContext = React.createContext<WidgetSettingsContextValue | undefined>(undefined);
 ...
 */
export function WidgetSettingsProvider({ children }: { children: React.ReactNode }) {
