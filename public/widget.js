...
function theme(){
  ...
  if(dark){
    ...
    if(i){
      ...
      // Update focus handler for dark mode - use white with 2px border for visibility
      i.setAttribute('onfocus',"this.style.borderWidth='2px';this.style.borderColor='#ffffff';this.style.outline='none';");
      i.setAttribute('onblur',"this.style.borderWidth='1px';this.style.borderColor='#374151';this.style.outline='none';");
    }
    ...
    if(i){
      ...
      i.setAttribute('placeholder',C.p);
      // Update focus handler for light mode - darker border with 2px width
      i.setAttribute('onfocus',"this.style.borderWidth='2px';this.style.borderColor='#6b7280';this.style.outline='none';");
      i.setAttribute('onblur',"this.style.borderWidth='1px';this.style.borderColor='#e5e7eb';this.style.outline='none';");
    }
