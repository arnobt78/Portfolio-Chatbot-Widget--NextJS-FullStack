...
function theme(){
  ...
  if(dark){
    ...
    if(i){
      // Ensure transition is set BEFORE changing colors to prevent flicker
      i.style.transition='border-color 0.2s ease,background-color 0.2s ease,color 0.2s ease';
      // Use requestAnimationFrame to ensure transition is applied before color change
      ...
      // Update focus handler for dark mode - use white for testing visibility
      i.setAttribute('onfocus',"this.style.borderColor='#ffffff';this.style.outline='none';");
