...
function theme(){
  ...
  if(dark){
    ...
    if(i){
      ...
      // Update focus handler for dark mode - use white box-shadow (no layout shift)
      i.setAttribute('onfocus',"this.style.borderColor='#ffffff';this.style.boxShadow='0 0 0 2px #ffffff';this.style.outline='none';");
    ...
    if(i){
      ...
      i.style.boxSizing='border-box';
      i.setAttribute('placeholder',C.p);
      // Update focus handler for light mode - lighter border with box-shadow (no layout shift)
      i.setAttribute('onfocus',"this.style.borderColor='#9ca3af';this.style.boxShadow='0 0 0 2px #9ca3af';this.style.outline='none';");
